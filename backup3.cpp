...
void loop()
{
	...
	if (currentMillis1 - previousMillis1 > interval) {
		...
		if (Firebase.setInt(firebaseData, "/Sensors/totalMilliLitres1", totalMilliLitres1)){}
	}
	...
	if (currentMillis2 - previousMillis2 > interval) {
		...
		if (Firebase.setInt(firebaseData, "/Sensors/totalMilliLitres2", totalMilliLitres2)){}
	}

	if (Firebase.setInt(firebaseData, "/Status/dayTotalVolume", totalMilliLitres1)){}
